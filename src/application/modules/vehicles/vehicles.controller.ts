...
export class VehiclesController {
  ...
  public async search(@Query() filter?: SearchVehiclesRequest): Promise<VehiclesPagedResponse> {
    ...
    const result = await this.mediator.execute<SearchVehiclesQuery, any>(query);
    return {
      ...result,
      items: this.mapper.mapArray(result.items, Vehicle, VehicleResponse),
    };
  }
  ...
  @Post()
  public async create(@Body() body: CreateVehicleRequest): Promise<VehicleResponse> {
