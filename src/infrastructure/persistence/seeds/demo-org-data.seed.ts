...
const BR = {
  mumbai: 'cc000001-0000-4000-8000-000000000001',
  delhi:  'cc000001-0000-4000-8000-000000000002',
  pune:   'cc000001-0000-4000-8000-000000000003',
};

const LOC = {
  mainStore:   'dd000001-0000-4000-8000-000000000001',
  mumbaiStore: 'dd000001-0000-4000-8000-000000000002',
  mumbaiWh:    'dd000001-0000-4000-8000-000000000003',
  delhiStore:  'dd000001-0000-4000-8000-000000000004',
  delhiWh:     'dd000001-0000-4000-8000-000000000005',
  puneStore:   'dd000001-0000-4000-8000-000000000006',
};

const CAT = {
  beverages:   'ee000001-0000-4000-8000-000000000001',
  snacks:      'ee000001-0000-4000-8000-000000000002',
  dairy:       'ee000001-0000-4000-8000-000000000003',
  grains:      'ee000001-0000-4000-8000-000000000004',
  spices:      'ee000001-0000-4000-8000-000000000005',
  personalCare:'ee000001-0000-4000-8000-000000000006',
  household:   'ee000001-0000-4000-8000-000000000007',
  frozen:      'ee000001-0000-4000-8000-000000000008',
  bakery:      'ee000001-0000-4000-8000-000000000009',
  tobacco:     'ee000001-0000-4000-8000-00000000000a',
};

const PRD = {
  water:  'ff000001-0000-4000-8000-000000000001',
  mango:  'ff000001-0000-4000-8000-000000000002',
  lays:   'ff000001-0000-4000-8000-000000000003',
  parleg: 'ff000001-0000-4000-8000-000000000004',
  milk:   'ff000001-0000-4000-8000-000000000005',
  rice:   'ff000001-0000-4000-8000-000000000006',
  salt:   'ff000001-0000-4000-8000-000000000007',
  dettol: 'ff000001-0000-4000-8000-000000000008',
  surf:   'ff000001-0000-4000-8000-000000000009',
  bread:  'ff000001-0000-4000-8000-00000000000a',
};

const INV = {
  water:  '11000001-0000-4000-8000-000000000001',
  mango:  '11000001-0000-4000-8000-000000000002',
  lays:   '11000001-0000-4000-8000-000000000003',
  parleg: '11000001-0000-4000-8000-000000000004',
  milk:   '11000001-0000-4000-8000-000000000005',
  rice:   '11000001-0000-4000-8000-000000000006',
  salt:   '11000001-0000-4000-8000-000000000007',
  dettol: '11000001-0000-4000-8000-000000000008',
  surf:   '11000001-0000-4000-8000-000000000009',
  bread:  '11000001-0000-4000-8000-00000000000a',
};

const SUP = {
  hul:    '22000001-0000-4000-8000-000000000001',
  itc:    '22000001-0000-4000-8000-000000000002',
  amul:   '22000001-0000-4000-8000-000000000003',
  nestle: '22000001-0000-4000-8000-000000000004',
  parle:  '22000001-0000-4000-8000-000000000005',
  dabur:  '22000001-0000-4000-8000-000000000006',
  brit:   '22000001-0000-4000-8000-000000000007',
  tata:   '22000001-0000-4000-8000-000000000008',
  marico: '22000001-0000-4000-8000-000000000009',
  emami:  '22000001-0000-4000-8000-00000000000a',
};

const CUST = {
  rahul:  '33000001-0000-4000-8000-000000000001',
  priya:  '33000001-0000-4000-8000-000000000002',
  suresh: '33000001-0000-4000-8000-000000000003',
  anita:  '33000001-0000-4000-8000-000000000004',
  vikram: '33000001-0000-4000-8000-000000000005',
  kavita: '33000001-0000-4000-8000-000000000006',
  arun:   '33000001-0000-4000-8000-000000000007',
  deepa:  '33000001-0000-4000-8000-000000000008',
  nikhil: '33000001-0000-4000-8000-000000000009',
  sunita: '33000001-0000-4000-8000-00000000000a',
};

const PO = {
  po1: 'aa000001-0000-4000-8000-000000000001',
  po2: 'aa000001-0000-4000-8000-000000000002',
  po3: 'aa000001-0000-4000-8000-000000000003',
  po4: 'aa000001-0000-4000-8000-000000000004',
  po5: 'aa000001-0000-4000-8000-000000000005',
};

const ORD = {
  ord1: 'bb000001-0000-4000-8000-000000000001',
  ord2: 'bb000001-0000-4000-8000-000000000002',
  ord3: 'bb000001-0000-4000-8000-000000000003',
  ord4: 'bb000001-0000-4000-8000-000000000004',
  ord5: 'bb000001-0000-4000-8000-000000000005',
};
...
export class DemoOrgDataSeed {
  ...
  private async seedPurchaseOrdersAsync(qr: QueryRunner): Promise<void> {
    ...
    await qr.query(`
      ...
      VALUES
        ('44000001-0000-4000-8000-000000000001', '${PO.po1}', '${PRD.water}',  100, 100, 100, 10,  1000),
        ('44000001-0000-4000-8000-000000000002', '${PO.po1}', '${PRD.mango}',   80,  80,  80, 12,   960),
        ('44000001-0000-4000-8000-000000000003', '${PO.po2}', '${PRD.milk}',    50,  50,  50, 52,  2600),
        ('44000001-0000-4000-8000-000000000004', '${PO.po2}', '${PRD.dettol}',  60,  60,  60, 28,  1680),
        ('44000001-0000-4000-8000-000000000005', '${PO.po3}', '${PRD.parleg}', 200, 200, 200,  7,  1400),
        ('44000001-0000-4000-8000-000000000006', '${PO.po3}', '${PRD.lays}',   150, 150, 150,  8,  1200),
        ('44000001-0000-4000-8000-000000000007', '${PO.po4}', '${PRD.salt}',   100,   0,   0, 16,  1600),
        ('44000001-0000-4000-8000-000000000008', '${PO.po4}', '${PRD.surf}',    30,   0,   0, 90,  2700),
        ('44000001-0000-4000-8000-000000000009', '${PO.po5}', '${PRD.rice}',    50,   0,   0, 70,  3500),
        ('44000001-0000-4000-8000-00000000000a', '${PO.po5}', '${PRD.bread}',   80,   0,   0, 32,  2560)
      ON CONFLICT (id) DO NOTHING
    `);
  }
  ...
  private async seedOrdersAsync(qr: QueryRunner): Promise<void> {
    ...
    await qr.query(`
      INSERT INTO core.order_items (id, order_id, product_id, quantity, unit_price, tax_amount, line_total) VALUES
        ('55000001-0000-4000-8000-000000000001', '${ORD.ord1}', '${PRD.water}',  20,  18, 0,  360),
        ('55000001-0000-4000-8000-000000000002', '${ORD.ord1}', '${PRD.lays}',   30,  20, 0,  600),
        ('55000001-0000-4000-8000-000000000003', '${ORD.ord1}', '${PRD.salt}',   10,  24, 0,  240),
        ('55000001-0000-4000-8000-000000000004', '${ORD.ord2}', '${PRD.milk}',   15,  65, 0,  975),
        ('55000001-0000-4000-8000-000000000005', '${ORD.ord2}', '${PRD.parleg}', 25,  12, 0,  300),
        ('55000001-0000-4000-8000-000000000006', '${ORD.ord3}', '${PRD.rice}',   10,  95, 0,  950),
        ('55000001-0000-4000-8000-000000000007', '${ORD.ord3}', '${PRD.mango}',  20,  22, 0,  440),
        ('55000001-0000-4000-8000-000000000008', '${ORD.ord3}', '${PRD.dettol}', 12,  42, 0,  504),
        ('55000001-0000-4000-8000-000000000009', '${ORD.ord4}', '${PRD.surf}',   20, 130, 0, 2600),
        ('55000001-0000-4000-8000-00000000000a', '${ORD.ord4}', '${PRD.bread}',  30,  48, 0, 1440),
        ('55000001-0000-4000-8000-00000000000b', '${ORD.ord5}', '${PRD.water}',  50,  18, 0,  900),
        ('55000001-0000-4000-8000-00000000000c', '${ORD.ord5}', '${PRD.lays}',   40,  20, 0,  800)
      ON CONFLICT (id) DO NOTHING
    `);
  }
  ...
  private async seedStockMovementsAsync(qr: QueryRunner): Promise<void> {
    await qr.query(`
      ...
      VALUES
        ('66000001-0000-4000-8000-000000000001','${INV.water}',  '${LOC.mainStore}','${PRD.water}',  '${PO.po1}','purchase_order','stock_in', 100,130,230, 10,'Received PO-DEMO-00001'),
        ('66000001-0000-4000-8000-000000000002','${INV.mango}',  '${LOC.mainStore}','${PRD.mango}',  '${PO.po1}','purchase_order','stock_in',  80,130,210, 12,'Received PO-DEMO-00001'),
        ('66000001-0000-4000-8000-000000000003','${INV.milk}',   '${LOC.mainStore}','${PRD.milk}',   '${PO.po2}','purchase_order','stock_in',  50, 65,115, 52,'Received PO-DEMO-00002'),
        ('66000001-0000-4000-8000-000000000004','${INV.dettol}', '${LOC.mainStore}','${PRD.dettol}', '${PO.po2}','purchase_order','stock_in',  60,108,168, 28,'Received PO-DEMO-00002'),
        ('66000001-0000-4000-8000-000000000005','${INV.parleg}', '${LOC.mainStore}','${PRD.parleg}', '${PO.po3}','purchase_order','stock_in', 200,375,575,  7,'Received PO-DEMO-00003'),
        ('66000001-0000-4000-8000-000000000006','${INV.lays}',   '${LOC.mainStore}','${PRD.lays}',   '${PO.po3}','purchase_order','stock_in', 150,230,380,  8,'Received PO-DEMO-00003'),
        ('77000001-0000-4000-8000-000000000001','${INV.water}',  '${LOC.mainStore}','${PRD.water}',  '${ORD.ord1}','order','stock_out', 20,250,230, 10,'Sale ORD-DEMO-00001'),
        ('77000001-0000-4000-8000-000000000002','${INV.lays}',   '${LOC.mainStore}','${PRD.lays}',   '${ORD.ord1}','order','stock_out', 30,410,380,  8,'Sale ORD-DEMO-00001'),
        ('77000001-0000-4000-8000-000000000003','${INV.salt}',   '${LOC.mainStore}','${PRD.salt}',   '${ORD.ord1}','order','stock_out', 10,200,190, 16,'Sale ORD-DEMO-00001'),
        ('77000001-0000-4000-8000-000000000004','${INV.milk}',   '${LOC.mainStore}','${PRD.milk}',   '${ORD.ord2}','order','stock_out', 15,130,115, 52,'Sale ORD-DEMO-00002'),
        ('77000001-0000-4000-8000-000000000005','${INV.parleg}', '${LOC.mainStore}','${PRD.parleg}', '${ORD.ord2}','order','stock_out', 25,600,575,  7,'Sale ORD-DEMO-00002'),
        ('77000001-0000-4000-8000-000000000006','${INV.rice}',   '${LOC.mainStore}','${PRD.rice}',   '${ORD.ord3}','order','stock_out', 10,100, 90, 70,'Sale ORD-DEMO-00003'),
        ('77000001-0000-4000-8000-000000000007','${INV.mango}',  '${LOC.mainStore}','${PRD.mango}',  '${ORD.ord3}','order','stock_out', 20,230,210, 12,'Sale ORD-DEMO-00003'),
        ('77000001-0000-4000-8000-000000000008','${INV.dettol}', '${LOC.mainStore}','${PRD.dettol}', '${ORD.ord3}','order','stock_out', 12,180,168, 28,'Sale ORD-DEMO-00003'),
        ('77000001-0000-4000-8000-000000000009','${INV.surf}',   '${LOC.mainStore}','${PRD.surf}',   '${ORD.ord4}','order','stock_out', 20, 60, 40, 90,'Sale ORD-DEMO-00004'),
        ('77000001-0000-4000-8000-00000000000a','${INV.bread}',  '${LOC.mainStore}','${PRD.bread}',  '${ORD.ord4}','order','stock_out', 30,180,150, 32,'Sale ORD-DEMO-00004'),
        ('77000001-0000-4000-8000-00000000000b','${INV.water}',  '${LOC.mainStore}','${PRD.water}',  '${ORD.ord5}','order','stock_out', 50,280,230, 10,'Sale ORD-DEMO-00005'),
        ('77000001-0000-4000-8000-00000000000c','${INV.lays}',   '${LOC.mainStore}','${PRD.lays}',   '${ORD.ord5}','order','stock_out', 40,420,380,  8,'Sale ORD-DEMO-00005')
      ON CONFLICT (id) DO NOTHING
    `);
  }
}
